    ...
    <PageWrapper>
      <main className="max-w-4xl mx-auto px-4 py-8 text-sm md:text-base leading-7 space-y-6">
        ...
        <div>
          ...
          <p>Our website address is: https://readgro.com.</p>
        </div>
        ...
        <div>
          ...
          <p>
            ...
            https://readgro.com. After approval of your comment, your profile
        ...
        <div>
          <h2 className="text-lg font-semibold">Who we share your data with</h2>
          <p>
        ...
        <div>
          <h2 className="text-lg font-semibold">Where we send your data</h2>
          <p>
